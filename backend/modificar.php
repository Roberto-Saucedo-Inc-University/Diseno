        ...
        <form method="post" action="Actualizar.php">
            ...
            <div class="campo">
                ...
                <input type="text" name="Titulo" id="titulo" value="<?php
                    if (mb_detect_encoding($programa["titulo"], 'UTF-8', true) !== 'UTF-8') {
                         echo utf8_encode($programa["titulo"]);
                    } else {
                ...
                <div id="Container">
                    <?php
                    if (mb_detect_encoding($programa["pagina"], 'UTF-8', true) !== 'UTF-8') {
                        $programa["pagina"] = utf8_encode($programa["pagina"]);
                    }
                    echo $programa["pagina"];
                    ?>
                </div>
